        ...
        <div className="home-container">
            ...
            <section id="collections" className="collections-section">
                <h2 className="section-title">
                    <span className="desktop-text">The Royal Collection</span>
                    <span className="mobile-text">Explore our exquisite types of collections</span>
                </h2>
                {!selectedCategory ? (
                    <>
                        <p className="subtitle desktop-text">Explore our exquisite types of collections</p>
                                ...
                                .map((item) => (
                                    <div className="card" key={item.id}>
                                        <div
                                            ...
                                            onClick={() => setZoomedImage(item.path)}
                                            style={{
                                        ...
                                        <div className="card-info">
                                            ...
                                            <div className="card-actions">
                                                ...
                                                <div className="card-buttons">
                                                    <button className="btn-icon-only highlight-icon" title="Add to Wishlist" onClick={() => handleAddToCart(item)}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#B76E79" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                                                    </button>
                                                    <button className="btn-icon-only highlight-icon" title="Shop Now" onClick={() => {
                                                        const text = `I want to buy: ${item.title} (Price: ${item.price})\nImage: ${window.location.origin}${item.path}`;
                                                        window.open(`https://wa.me/919652541331?text=${encodeURIComponent(text)}`, '_blank');
                                                    }}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
                                                    </button>
            ...
            <footer className="footer">
                <div className="footer-content">
                    ...
                    <div className="footer-social">
                        <h4>Follow Us</h4>
                        <ul>
                            <li><a href="https://www.instagram.com/sri_collections09?igsh=MXU4YTU4Y2tkdXk3ag%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer">Instagram</a></li>
                ...
                <div className="modal-overlay" onClick={() => setSelectedProduct(null)}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            <div className="modal-left" onClick={() => setZoomedImage(selectedProduct.path)} style={{ cursor: 'zoom-in' }}>
                                <div
                                    className={`modal-image-view ${selectedProduct.gradientClass || ''}`}
                                    style={selectedProduct.path ? { backgroundImage: `url(${selectedProduct.path})` } : {}}
                                ></div>
                            </div>
                            <div className="modal-right">
                                ...
                                <div className="modal-actions">
                                    <button className="btn-order" onClick={() => {
                                        const text = `I'm interested in ordering: ${selectedProduct.title} (Price: ${selectedProduct.price})\nImage: ${window.location.origin}${selectedProduct.path}`;
                                        window.open(`https://wa.me/919652541331?text=${encodeURIComponent(text)}`, '_blank');
                                    }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg> Order Now
                                    </button>
                                    <button className="btn-cart" onClick={() => handleAddToCart(selectedProduct)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg> Add to Wishlist
                                    </button>
                        ...
                        <>
                            {cart.map((item) => (
                                <div className="cart-item" key={item.id}>
                                    <div
                                        ...
                                        style={item.path ? { backgroundImage: `url(${item.path})` } : {}}
                                    ></div>
                            ...
                            <div className="cart-footer">
                                <button className="btn-primary checkout-btn" onClick={() => {
                                     const text = `I'm interested in buying:\n${cart.map(i => `- ${i.title} (${i.price})\n  Image: ${window.location.origin}${i.path}`).join('\n')}`;
                                     window.open(`https://wa.me/919652541331?text=${encodeURIComponent(text)}`, '_blank');
                                }}>
            ...
            {zoomedImage && (
                <div className="image-zoom-overlay" onClick={() => setZoomedImage(null)}>
                    <div className="zoom-content" onClick={(e) => e.stopPropagation()}>
                        <button className="zoom-close" onClick={() => setZoomedImage(null)}>&times;</button>
                        <img
                            src={zoomedImage}
                            alt="Zoomed Product"
